...
public class BarActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final Button bar = (Button) findViewById(R.id.bar);
        bar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(BarActivity.this,"Nearby Bar", Toast.LENGTH_LONG).show();
            }
        });
    }
